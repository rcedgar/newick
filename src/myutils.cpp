...
#endif
	;
	fprintf(f, PROGRAM_NAME " v%s.%u_%s%s", MY_VERSION, GitVersionCounter, GetPlatform(), Flags);
	}
...
void PrintCopyright(FILE *f)
	...
	fprintf(f, "  %s RAM", MemBytesToStr(RAM));
	fprintf(f, ", %u cores\n", GetCPUCoreCount());
	fprintf(f, "(C) Copyright 2020-21 Robert C. Edgar, all rights reserved.\n");
